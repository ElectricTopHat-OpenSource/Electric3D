...
#pragma mark ---------------------------------------------------------
	...
	// Constructor
	// --------------------------------------------------
	E3DSplineManager::E3DSplineManager()
	{
...
#pragma mark ---------------------------------------------------------
	...
	// --------------------------------------------------
	BOOL E3DSplineManager::isLoaded( const NSString * _name, const NSString * _ext, NSBundle * _bundle )
	{
	...
	// is the spline loaded
	// --------------------------------------------------
	BOOL E3DSplineManager::isLoaded( const NSString * _filePath )
	{
	...
	// load a spline
	// --------------------------------------------------
	const E3DSpline * E3DSplineManager::load( const NSString * _name, const NSString * _ext, NSBundle * _bundle )
	{
		NSBundle * bundle	= ( _bundle ) ? _bundle : [NSBundle mainBundle];
		NSString * path		= [bundle pathForResource:_name ofType:_ext];
		if ( path )
	...
	// load a mesh
	// --------------------------------------------------
	const E3DSpline * E3DSplineManager::load( const NSString * _filePath )
	{
	...
	// release a mesh
	// --------------------------------------------------
	void E3DSplineManager::release( const E3DSpline * _spline )
	{
		if ( _spline )
		{
...
#pragma mark ---------------------------------------------------------
	...
	// --------------------------------------------------
	E3DSpline * E3DSplineManager::loadplist( const NSString * _filePath )
	{
	...
	// --------------------------------------------------
	E3DSpline * E3DSplineManager::load3DS( const NSString * _filePath )
	{
