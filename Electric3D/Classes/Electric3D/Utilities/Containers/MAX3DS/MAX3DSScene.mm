...
{	
	...
	// Constructor
	// ---------------------------------------------------------------
	MAX3DSScene::MAX3DSScene(NSData * _data)
	: m_data		( nil )
	{
		set( _data );
	}
	...
	// Constructor
	// ---------------------------------------------------------------
	MAX3DSScene::MAX3DSScene(const void * _data, int _len)
	: m_data		( nil )
	{
		set( _data, _len );
	}
	...
	// ---------------------------------------------------------------
	BOOL MAX3DSScene::set( NSData * _data )
	{
		invalidate();
	...
	// change the model data
	// ---------------------------------------------------------------
	BOOL MAX3DSScene::set( const void * _data, int _len )
	{
		invalidate();
	...
	// ---------------------------------------------------------------
	BOOL MAX3DSScene::fill( const void * _data, int _len )
	{
	...
	void MAX3DSScene::read_OBJMESH( const unsigned char * _data, int _len )
	{
		MAX3DS_ChunkHeader chunk;
		int hsize			= MAX3DS_ChunkHeaderSize;
		int pos				= 0;
	...
	void MAX3DSScene::read_OBJBLOCK( const unsigned char * _data, int _len )
	{
	...
	void MAX3DSScene::read_TRIMESH( const unsigned char * _data, int _len, MAX3DS_OBJECT & _object )
	{
		MAX3DS_ChunkHeader chunk;
		int hsize			= MAX3DS_ChunkHeaderSize;
		int pos				= 0;
