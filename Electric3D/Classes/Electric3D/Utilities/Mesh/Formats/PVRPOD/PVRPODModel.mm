...
{	
	...
	// Constructor
	// ---------------------------------------------------------------
	PVRPODModel::PVRPODModel(NSData * _data)
	: m_data		( nil )
	, m_offset		( 0 )
	{
	...
	// Constructor
	// ---------------------------------------------------------------
	PVRPODModel::PVRPODModel(const void * _data, int _len)
	: m_data		( nil )
	, m_offset		( 0 )
	{
		memset(&m_scene, 0, sizeof(PODScene));
	...
	// ---------------------------------------------------------------
	BOOL PVRPODModel::isUsingIndexedTriangles() const 
	{ 
	...
	// ---------------------------------------------------------------
	BOOL PVRPODModel::set( NSData * _data )
	{
		invalidate();
	...
	// change the model data
	// ---------------------------------------------------------------
	BOOL PVRPODModel::set( const void * _data, int _len )
	{
		invalidate();
	...
	// ---------------------------------------------------------------
	void * PVRPODModel::mpool( unsigned int _size )
	{
	...
	// ---------------------------------------------------------------
	void *  PVRPODModel::mpoolcpy( unsigned int _size, const void * _data )
	{
	...
	// ---------------------------------------------------------------
	BOOL PVRPODModel::fill( const void * _data, int _len )
	{
	...
	BOOL PVRPODModel::read_SCENE( const unsigned char * _data, int _len )
	{
		PODChunkInfo * chunk;
		int hsize				= sizeof(PODChunkInfo);
		int pos					= 0;
	...
	int PVRPODModel::read_CAMERA( const unsigned char * _data, int _len, PODCamera * _cam )
	{
		PODChunkInfo *		chunk;
		int hsize			= sizeof(PODChunkInfo);
		int pos				= 0;
	...
	int PVRPODModel::read_LIGHT( const unsigned char * _data, int _len, PODLight * _light )
	{
		PODChunkInfo *		chunk;
		int hsize			= sizeof(PODChunkInfo);
		int pos				= 0;
	...
	int PVRPODModel::read_MATERIAL( const unsigned char * _data, int _len, PODMaterial * _material )
	{
		PODChunkInfo *		chunk;
		int hsize			= sizeof(PODChunkInfo);
		int pos				= 0;
	...
	int PVRPODModel::read_MESH( const unsigned char * _data, int _len, PODMesh * _mesh )
	{
		PODChunkInfo *		chunk;
		int hsize			= sizeof(PODChunkInfo);
		int pos				= 0;
	...
	int PVRPODModel::read_NODE( const unsigned char * _data, int _len, PODNode * _node )
	{
		PODChunkInfo *		chunk;
		int hsize			= sizeof(PODChunkInfo);
		int pos				= 0;
	...
	int PVRPODModel::read_TEXTURE( const unsigned char * _data, int _len, PODTexture * _texture )
	{
		PODChunkInfo *		chunk;
		int hsize			= sizeof(PODChunkInfo);
		int pos				= 0;
	...
	int PVRPODModel::read_PODData( const unsigned char * _data, int _len, ePODFileName _spec, bool _validData, PODData * _poddat )
	{
		PODChunkInfo *		chunk;
		int hsize			= sizeof(PODChunkInfo);
		int pos				= 0;
