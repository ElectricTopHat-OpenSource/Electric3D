...
#if !defined(__GLUISprite_h__)
#define __GLUISprite_h__
...
namespace UI
{
	...
	// the desired texture.
	// -------------------------------------------------------------------
	class GLUISprite : public GLUIObject
	{
#pragma mark ---------------------------------------------------------
...
#pragma mark ---------------------------------------------------------
	public:	// Functions
		...
		inline eGLUICoordinatesLayout textureCoordinatesLayout() const { return m_textureCoordinatesLayout; };
		// set the texture coordinate layout
		inline void setTextureCoordinatesLayout( eGLUICoordinatesLayout _layout ) { m_textureCoordinatesLayout = _layout; };
