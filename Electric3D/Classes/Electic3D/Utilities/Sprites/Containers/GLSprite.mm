...
#pragma mark ---------------------------------------------------------
	...
	// Constructor
	// --------------------------------------------------
	GLSprite::GLSprite(const NSString * _name, const GLTextures::GLTexture * _texture, NSUInteger _frameCount, CGSize _frameSize)
	: m_referenceCount	( 1 )
	, m_texture			( _texture )
	, m_name			( _name )
	...
	// Constructor
	// --------------------------------------------------
	GLSprite::GLSprite(const NSString * _name, const GLTextures::GLTexture * _texture, NSArray * _frames)
	: m_referenceCount	( 1 )
	, m_texture			( _texture )
	, m_name			( _name )
	{
